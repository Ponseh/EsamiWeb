Instructions to create the db and the tables

Go to phpMyAdmin and go to the tab of the menu "SQL".

1. Create the DB

CREATE DATABASE db_esami;

2. Select the newly created database and use the following instructions to create and populate the table
